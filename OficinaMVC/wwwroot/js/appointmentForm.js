$(document).ready(function () {
    ...
    const submitButton = $('form button[type="submit"]'); // -- Get the submit button --
    ...
    const fp = flatpickr("#AppointmentDate", {
        ...
        onMonthChange: function (selectedDates, dateStr, instance) {
            ...
            fetchUnavailableDays(currentYear, currentMonth, function () { instance.redraw(); });
        },
    ...
    clientSelect.on('change', function () {
        ...
        submitButton.prop('disabled', true); // -- DISABLE BUTTON on client change --
    ...
    // When a vehicle is selected, enable the submit button.
    ...
    // -- ADD THIS LINE --
    // Initial check to disable button on page load
    submitButton.prop('disabled', true);
});