        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_AspNetUsers_MechanicId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepairUser", x => new { x.MechanicsId, x.RepairId });
                    table.ForeignKey(
                        name: "FK_RepairUser_AspNetUsers_MechanicsId",
                        column: x => x.MechanicsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RepairUser_Repairs_RepairId",
                        column: x => x.RepairId,
